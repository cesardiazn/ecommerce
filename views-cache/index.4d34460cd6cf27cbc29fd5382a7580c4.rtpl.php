                ...
                <div class="col-md-12">
                    <div class="latest-product">
                        ...
                        <div class="product-carousel">
                            ...
                            <!-- Tomamos el codigo de solo un producto y definimos un Loop para
                            utilizar con n productos -->
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-carousel-price">
                                    <ins>R$ <?php echo formatPrice($value1["vlprice"]); ?></ins> <!-- <del>$100.00</del>  precio de promocion-->
                                </div> 
                            </div>
                            <?php } ?>
