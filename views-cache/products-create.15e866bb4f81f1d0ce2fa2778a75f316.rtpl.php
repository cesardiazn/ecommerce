  	...
  	<div class="col-md-12">
        ...
        <form role="form" action="/admin/products/create" method="post">
          <div class="box-body">
            ...
            <!-- 
              +++++++++++++++++++++++++++++++++++++++++++
              Falta el campo para asignar la foto, pero debemos primero saber el id del producto
              para poder asignar el nombre de dicha foto, por lo que de momento quedara inhabilitada
              la seleccion de la foto, en el formulario de cadastro.
