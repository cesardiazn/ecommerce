...
<div class="single-product-area">
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- Vamos a reemplazar el codigo un loop que se genere con los datos de la DB-->
            ...
            <!--  
                ********************************************
                El siguiente codigo es reemplazado por el loop anterior.
                puede ser borrado
            ...
            <div class="col-md-12">
                <div class="product-pagination text-center">
                    <nav>
                        ...
                        <li>
                            <a href="<?php echo htmlspecialchars( $page_mov["prev"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" aria-label="Previous">
                        ...
                        <li>
                            <a href="<?php echo htmlspecialchars( $page_mov["forw"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" aria-label="Next">
                            <span aria-hidden="true">»</span>
                            </a>
                        </li>
