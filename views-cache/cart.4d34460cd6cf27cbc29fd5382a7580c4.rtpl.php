                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-remove">
                                            <!-- Link para remover todos los productos de un item -->
                                            <a title="Remove this item" class="remove" href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/remove"><img border="0" alt="Remover" src="/views/img/trash.png" width="35" height="40"></a> 
                                        </td>

                                        <td class="product-thumbnail">
                                            <a href="/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"></a> <!-- La fotografia del producto-->
                                        </td>
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr class="order-total">
                                                <th>Total</th>
                                                <td><strong><span class="amount"><?php if( $cart["vltotal"] > 0 ){ ?>R$<?php echo formatPrice($cart["vltotal"]); ?><?php } ?></span></strong> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
